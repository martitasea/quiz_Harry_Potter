...
let questionDb = [
  {
    ...
    rightAnswer: 0,
    image:"/quiz_Harry_Potter/img/varita.jpg",
  ...
  },
  {
    ...
    rightAnswer: 1,
    image:"/quiz_Harry_Potter/img/Luna_Lovegood.jpg",
  ...
  },
  {
    ...
    rightAnswer: 2,
    image:"/quiz_Harry_Potter/img/beso.jpg",
  ...
  },
  {
    ...
    rightAnswer: 0,
    image:"/quiz_Harry_Potter/img/lily.jpg",
  ...
  },
  {
    ...
    rightAnswer: 2,
    image:"/quiz_Harry_Potter/img/hagrid.jpg",
  ...
  },
  {
    ...
    rightAnswer: 1,
    image:"/quiz_Harry_Potter/img/cementerio.jpg",
  ...
  },
  {
    ...
    rightAnswer: 0,
    image:"/quiz_Harry_Potter/img/neville.jpg",
  ...
  },
  {
    ...
    rightAnswer: 1,
    image:"/quiz_Harry_Potter/img/books.png",
  ...
  },
  {
    ...
    rightAnswer: 1,
    image:"/quiz_Harry_Potter/img/voldemort.jpg",
  ...
  },
  {
    ...
    answers: [
      ...
      "Roger Davies"],
    rightAnswer: 2,
    image:"/quiz_Harry_Potter/img/dumbledore.jpg",
  ...
  },
  {
    ...
    answers: [
      ...
      "Mafalda"],
    rightAnswer: 0,
    image:"/quiz_Harry_Potter/img/srafigg.jpg",
  ...
  },
  {
    ...
    answers: [
      ...
      "Cera de oído"],
    rightAnswer: 2,
    image:"/quiz_Harry_Potter/img/bertie.png",
  ...
  },
  {
    ...
    rightAnswer: 2,
    image:"/quiz_Harry_Potter/img/hogwarts.jpg",
...
function comparar() {
  ...
  if (aciertos == numAnswers) {
    mensaje = "Eres la máxima autoridad cuando se trata de Harry Potter y no hay quien te haga competencia. Por lo que te mereces en toda regla tu diploma. ¿O es que acaso las preguntas no eran lo suficientemente difíciles...?" ;
  } else if (aciertos > fallos) {
    mensaje = "Sabes que eres un Potterhead y no hay quien lo niegue, aunque hayas aprobado de raspadillo. ¿Te dijeron que no valía mirar en internet? Descarga el diploma pero, ¡pensaremos si tienes que ir a examen oral!";
  } else {
    mensaje = "Lo siento pero para conseguir el diploma debes intentarlo otra vez. Si pensabas que era fácil, lamentamos demostrarte lo contrario. Lo cierto es que te faltan muchas cosas por descubrir del maravilloso mundo de Harry Potter.";
  }
  let nextAction;
  let nextHref;
  let nextFile;
  if (aciertos > fallos) {
    nextAction = "DESCARGAR EL DIPLOMA";
    nextHref="/quiz_Harry_Potter/img/diploma_vacio.pdf"
    nextFile=`download="Diploma.pdf"`
  } else {
    nextAction = "COMENZAR";
    nextHref="question.html";
    nextFile=``;
  }
  ...
  let cardResults = `
    ...
    <a class="button special" href=${nextHref} ${nextFile}>${nextAction}</a>
    </div>    
    `;
